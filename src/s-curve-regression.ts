...
// MSE = sum{[y-f(x)]^2}
function mse(Y: number[], X: number[], a: number, b: number, c: number) {
...
export default function scurveFit(values: number[]) {
    ...
    const aStep = 0.000000000002;
    const bStep = 0.000000000002;
    const cStep = 0.000000000002;
